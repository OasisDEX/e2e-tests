...
test.describe('With real wallet - Mainnet USDC Higher Risk position page - Deposit', async () => {
	test.beforeEach(async ({ app, metamask }, testInfo) => {
		...
		await app.positionPage.open(
			'/earn/mainnet/position/0xe9cda459bed6dcfb8ac61cd8ce08e2d52370cb06/0x10649c79428d718621821cf6299e91920284743f',
		);
	...
	test('It should show Deposit balances and Deposit amounts - Mainnet USDC Higher Risk position page', async ({
		app,
	}) => {
		// === USDC ===
	...
	test('It should deposit USDC & WETH - (until rejecting "Deposit" tx) - Mainnet USDC Higher Risk position page', async ({
		app,
		metamask,
	}) => {
...
test.describe('With real wallet - Mainnet USDC Higher Risk position page - Withdraw', async () => {
	...
	test.skip('It should withdraw to USDC - (until rejecting "Withdraw" tx) - Mainnet USDC Higher Risk position page', async ({
		app,
		metamask,
	}) => {
		await withdraw({
...
test.describe('With real wallet - Mainnet USDC Higher Risk Position page - Unstake', async () => {
	test.beforeEach(async ({ app, metamask }, testInfo) => {
		testInfo.setTimeout(testInfo.timeout + 110_000);
	...
	test('It should Unstake LV tokens - Mainnet USDC Higher Risk position', async ({
		app,
		metamask,
	}) => {
