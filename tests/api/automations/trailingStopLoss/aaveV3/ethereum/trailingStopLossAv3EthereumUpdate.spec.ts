...
test.describe.skip(
	'API tests - Trailing Stop-Loss - Update - Aave V3 - Ethereum @regression',
	async () => {
		...
		test('Update existing automation - Wrong data type - "position" - array', async ({
			request,
		}) => {
			const response = await request.post(trailingStopLossEndpoint, {
		...
		test('Update existing automation - Wrong data type - "position" - null', async ({
			request,
		}) => {
			const response = await request.post(trailingStopLossEndpoint, {
		...
		test('Update existing automation - Wrong data type - "debt (position)"', async ({
			request,
		}) => {
			const response = await request.post(trailingStopLossEndpoint, {
				data: {
