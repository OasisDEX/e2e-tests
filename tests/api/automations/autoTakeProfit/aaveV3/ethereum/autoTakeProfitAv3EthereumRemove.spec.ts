...
const validPayloads = validPayloadsAaveV3Ethereum.autoTakeProfit.remove;
...
test.describe('API tests - Auto Take Profit - Remove - Aave V3 - Ethereum @regression', async () => {
