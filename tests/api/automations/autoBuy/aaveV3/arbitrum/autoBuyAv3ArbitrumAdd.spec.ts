...
const validPayloads = validPayloadsAaveV3Arbitrum.autoBuy.addWithoutMaxBuyPrice;
...
// SKIP - Position liquidated - New position needed for tests
test.describe.skip('API tests - Auto-Buy - Add - Aave V3 - Arbitrum', async () => {
