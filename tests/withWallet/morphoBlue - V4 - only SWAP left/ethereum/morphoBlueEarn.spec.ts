...
test.describe('Morpho Blue Earn - Wallet connected', async () => {
	...
	test('It should Deposit (same token - USDT) on an existing Morpho Blue Earn position @regression', async () => {
		test.info().annotations.push({
			type: 'Test case',
			description: 'xxxx',
		});
	...
	test('It should Withdraw from an existing Morpho Blue Earn position @regression', async () => {
		test.info().annotations.push({
			type: 'Test case',
			description: 'xxxx',
		});
	...
	test('It should Deposit (different token - ETH) on an existing Morpho Blue Earn position @regression', async () => {
		test.info().annotations.push({
			type: 'Test case',
			description: 'xxxx',
		});
