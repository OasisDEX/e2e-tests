...
| --- | --- | -- |
| BASE_URL | This is the base url used to run the tests. As per `.env.example` file. If you don't set this variable the tests will run with `https://pro.oasisapp.dev` as base url|
